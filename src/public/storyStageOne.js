...
const puppyThread = [
    ...
    { text: () => `${gameState.puppyName}'s gotten so much bigger already.` },
    { text: () => `You two have gotten pretty good at fending for yourselves, and now ${gameState.puppyName}'s bursting with energy.`},
    { text: "To be continued..."}
]
